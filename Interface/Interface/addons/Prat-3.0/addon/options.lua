...
기록 접근에 위쪽 아래쪽 키 대신 ALT-위와 ALT-아래 키를 사용하세요]=],
	...
	["History/Scrollback"] = "이전 대화 목록",
	["History/Scrollback Options"] = "이전 대화 목록 옵션",
	["History/scrollbacklen_desc"] = "이전 대화 목록 저장소에 저장할 대화 내용의 길이입니다.",
	["History/scrollbacklen_name"] = "이전 대화 목록 길이",
	...
	["Scroll/Chat window scrolling options."] = "대화창 스크롤 옵션입니다.",
