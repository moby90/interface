...
--> global name declaration
		...
		_detalhes.build_counter = 4615
		_detalhes.userversion = "v7.3.0." .. _detalhes.build_counter
		_detalhes.realversion = 125 --core version
