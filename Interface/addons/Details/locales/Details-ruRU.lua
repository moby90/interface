...
L["STRING_ATTRIBUTE_HEAL_ABSORBED"] = "Исцеление поглощено"
...
L["STRING_ATTRIBUTE_MISC_DEFENSIVE_COOLDOWNS"] = "Восстановление"
...
L["STRING_CHANNEL_WHISPER_TARGET_COOLDOWN"] = "Шепот цели восстановление"
L["STRING_CHANNEL_YELL"] = "Крикнуть"
L["STRING_CLICK_REPORT_LINE1"] = "|cFFFFCC22Щелчок|r: |cFFFFEE00отчёт|r"
...
L["STRING_CUSTOM_DAMAGEONANYMARKEDTARGET"] = "Урон от других отмеченных целей"
...
L["STRING_CUSTOM_DAMAGEONSHIELDS"] = "Урон в щиты"
L["STRING_CUSTOM_DAMAGEONSKULL"] = "Наносимый урон, по цели отмеченным черепом"
...
L["STRING_GUILDDAMAGERANK_TUTORIAL_DESC"] = [=[Details! хранит урон и исцеление, с каждого босса, которым сражалась ваша гильдия.
Просмотр истории путем проверки поля '|cFFFFFF00Показать историю|r', будут показаны результаты всех боев.
Путем выбора '|cFFFFFF00Показать ранг гильдии|r лучшие баллы для выбранного босса будут отображается.
Если вы впервые используете этот инструмент или потеряли день рейда, нажмите на '|cFFFFFF00Синхронизация с гильдией|r' кнопку.]=]
...
L["STRING_INFO_TUTORIAL_COMPARISON1"] = "Щелкните на |cFFFFDD00Сравнение|r вкладку, чтобы увидеть сравнение между игроками одного класса."
L["STRING_INSTANCE_CHAT"] = "Чат подземелья"
...
L["STRING_LAST_COOLDOWN"] = "последнее использованные восстановления"
L["STRING_LEFT"] = "слева"
...
L["STRING_MODE_OPENFORGE"] = "Аура кования"
L["STRING_MODE_OPENGUILDDAMAGERANK"] = "Рейтинг нанесённого урона"
...
L["STRING_NEWS_REINSTALL"] = "Найденные проблемы после обновления? Попробуйте команду '/details reinstall'."
...
L["STRING_NOLAST_COOLDOWN"] = "восстановления не использованы"
...
L["STRING_OPTIONS_AVATAR_ANCHOR"] = "Идентичность:"
L["STRING_OPTIONS_AVATAR_DESC"] = "Аватары также отправляются членам гильдии и отображаются в верхней части подсказок, и в окне details игрока."
...
L["STRING_OPTIONS_BAR_COLORBYCLASS_DESC"] = "Когда включено, эта текстура всегда используется цвет класса игрока."
...
L["STRING_OPTIONS_BARRIGHTTEXTCUSTOM2_DESC"] = [=[|cFFFFFF00{data1}|r: это первое пройденное число, обычно это число представляет итого выполненное.
...
L["STRING_OPTIONS_BARUR_DESC"] = "Когда включено значения, УВС и ИВС обновляются немного быстрее, чем обычно."
...
|cFFFFFF00Важно|r: изменения применяются после следующего вступления в бой.]=]
L["STRING_OPTIONS_BG_ANCHOR"] = "Поля боя:"
L["STRING_OPTIONS_BG_REMOTE_PARSER"] = "Умный счет"
L["STRING_OPTIONS_BG_REMOTE_PARSER_DESC"] = "Когда включено, повреждения и исцеления синхронизируются с таблицей баллов."
L["STRING_OPTIONS_CAURAS"] = "Собирать 'Ауры'"
L["STRING_OPTIONS_CAURAS_DESC"] = [=[Включить захват:

- |cFFFFFF00Полж. эфф. время|r
- |cFFFFFF00Отр. эфф. время|r
- |cFFFFFF00Войд зоны|r
-|cFFFFFF00 Восстановление|r]=]
L["STRING_OPTIONS_CDAMAGE"] = "Собирать 'Урон'"
L["STRING_OPTIONS_CDAMAGE_DESC"] = [=[Включить захват:

- |cFFFFFF00Наносимый урон|r
- |cFFFFFF00Урон в секунду|r
- |cFFFFFF00Огонь по своим|r
...
- |cFFFFFF00Исцеление сделано|r
- |cFFFFFF00Поглощения|r
- |cFFFFFF00Исцеление в секунду|r
- |cFFFFFF00Overhealing|r
- |cFFFFFF00Исцеление получено|r
- |cFFFFFF00Исцеление врага|r
...
L["STRING_OPTIONS_COMBAT_ALPHA_2"] = "Во время боя"
L["STRING_OPTIONS_COMBAT_ALPHA_3"] = "Пока вне бою"
L["STRING_OPTIONS_COMBAT_ALPHA_4"] = "Пока не в группе"
L["STRING_OPTIONS_COMBAT_ALPHA_5"] = "Пока не внутри подземелья"
L["STRING_OPTIONS_COMBAT_ALPHA_6"] = "Внутри подземелья"
L["STRING_OPTIONS_COMBAT_ALPHA_7"] = "Рейдовый отладчик"
L["STRING_OPTIONS_COMBAT_ALPHA_DESC"] = [=[Выберите, как бой влияют на прозрачность окна.
...
L["STRING_OPTIONS_COMBATTWEEKS"] = "Хитрости: Бой"
L["STRING_OPTIONS_COMBATTWEEKS_DESC"] = "Поведенческое корректировка о том, как Details! заниматься некоторыми аспектами боя."
...
L["STRING_OPTIONS_CUSTOMSPELLTITLE_DESC"] = "Эта панель позволяет изменять имя и значок заклинаний."
...
L["STRING_OPTIONS_ED"] = "Стереть данные"
...
L["STRING_OPTIONS_IGNORENICKNAME"] = "Игнорировать прозвища и аватары"
L["STRING_OPTIONS_IGNORENICKNAME_DESC"] = "Когда включено, прозвища и аватары, установленные другими членами гильдии, игнорируются."
...
L["STRING_OPTIONS_MENU_ALPHAENTER"] = "Наведите курсор мыши"
...
L["STRING_OPTIONS_MENU_ALPHALEAVE_DESC"] = "Когда нет мыши над окном, прозрачность меняется на это значение."
...
L["STRING_OPTIONS_MICRODISPLAYS_WARNING"] = [=[|cFFFFFF00Заметка|r: микро-дисплеи не могут быть показаны, потому что
они закреплены снизу
и сбоку панель состояния отключена.]=]
...
L["STRING_OPTIONS_MINIMAP_DESC"] = "Показать или скрыть значок у мини-карты."
L["STRING_OPTIONS_MISCTITLE"] = "Прочие настройки"
L["STRING_OPTIONS_MISCTITLE2"] = "Этот элемент управляется, несколькими вариантами."
L["STRING_OPTIONS_NICKNAME"] = "Прозвище"
L["STRING_OPTIONS_NICKNAME_DESC"] = [=[Задайте ваше прозвище.

Прозвища отправляются членам гильдии с Details! используется вместо имени персонажа.]=]
...
L["STRING_OPTIONS_PANIMODE_DESC"] = "Когда включено, и вас выбросило из игры (отключением, например в подземелье) и вы дрались против босса, все сегменты стираются, это делает ваш процесс выхода быстрее."
...
L["STRING_OPTIONS_PERFORMANCE_TYPES_DESC"] = "Это тип рейда, где различные параметры могут автоматически изменяться."
L["STRING_OPTIONS_PERFORMANCE1"] = "Производительность хитрости"
...
L["STRING_OPTIONS_REALMNAME"] = "Удалить имя мира"
L["STRING_OPTIONS_REALMNAME_DESC"] = [=[Когда включено, название сервера - персонажа не отображается.
...
L["STRING_OPTIONS_RT_COOLDOWNS_ANCHOR"] = "Объявлять восстановление:"
L["STRING_OPTIONS_RT_COOLDOWNS_CHANNEL"] = "Канал"
L["STRING_OPTIONS_RT_COOLDOWNS_CHANNEL_DESC"] = [=[Какой канал использовать для отправления сообщения оповещения.

Если выбран |cFFFFFF00Наблюдатель|r, все восстановления печатаются в чате, за исключением отдельного восстановления.]=]
...
Используйте |cFFFFFF00{spell}|r, чтобы добавить имя заклинания восстановление.

Используйте |cFFFFFF00{target}|r, чтобы добавить имя цели игрока.]=]
L["STRING_OPTIONS_RT_COOLDOWNS_ONOFF_DESC"] = "Когда вы используйте восстановление, сообщение отправляется по выбранному каналу."
L["STRING_OPTIONS_RT_COOLDOWNS_SELECT"] = "Игнорируемый список восстановления"
L["STRING_OPTIONS_RT_COOLDOWNS_SELECT_DESC"] = "Выберите, какие восстановления следует игнорировать."
...
L["STRING_OPTIONS_RT_DEATHS_ONOFF_DESC"] = "Когда член рейда умирает, отправляется сообщение в рейдовый канал, отчего умер тот игрок."
...
|cFFFFFF00Важно|r для рейдов /raid канал использовать, /p во время подземелья.

Если |cFFFFFF00Наблюдатель|r, то смерти показываются только для вас в чате.]=]
...
L["STRING_OPTIONS_RT_FIRST_HIT_DESC"] = "Пишет в панель чата (|cFFFFFF00только для вас|r), кто сделал первое попадание, обычно это тот, кто начинает бой."
L["STRING_OPTIONS_RT_IGNORE_TITLE"] = "Игнорировать восстановления"
...
L["STRING_OPTIONS_RT_INTERRUPT_ANCHOR"] = "Объявить прерывания:"
L["STRING_OPTIONS_RT_INTERRUPT_NEXT"] = "Следующий: %s"
L["STRING_OPTIONS_RT_INTERRUPTS_CHANNEL"] = "Канал"
L["STRING_OPTIONS_RT_INTERRUPTS_CHANNEL_DESC"] = [=[Какой канал используется для отправки, сообщение оповещения.

Если выбран |cFFFFFF00Наблюдатель|r, все прерывания показываться только вам в чат.]=]
...
Используйте |cFFFFFF00{spell}|r, чтобы добавить имя прерванного заклинания.

Используйте |cFFFFFF00{next}|r, чтобы добавить имя следующего игрока напишите его в 'next' поле.]=]
...
L["STRING_OPTIONS_RT_TITLE_DESC"] = "В этой панели Вы можете активировать различные механизмы, чтобы помочь вам во время рейдов."
...
L["STRING_OPTIONS_SPELL_NAMEERROR"] = "Недопустимое имя заклинания."
...
L["STRING_OPTIONS_SPELL_SPELLID_DESC"] = [=[ID - это уникальный номер для идентификации заклинаний в мире военного ремесла. Есть много способов, чтобы получить число:

- В окне информации игрока, удерживайте клавишу Shift при наведении заклинания полосы.
- Введите имя заклинания в поле Заклинание Id, всплывающая подсказка отображается с предложенными заклинаниями.
- Веб-сайты сообщества, большинство из которых имеют заклинание в адресной ссылке.
...
L["STRING_OPTIONS_TIMEMEASURE_DESC"] = [=[|cFFFFFF00Активный|r: таймер каждого игрока рейдовой группы, ставится на удержание, если их активность прекращается и снова подсчитывается при возобновлении, общий способ измерения УВС и ИВС.

|cFFFFFF00Эффективный|r: используется в рейтинге, этот метод использует прошедшее время боя для измерения УВС и ИВС - всех членов рейда.]=]
...
L["STRING_OPTIONS_TOOLTIPS_FONTCOLOR_DESC"] = "Измените цвет, используемый в текстах подсказках."
...
L["STRING_OPTIONS_TOOLTIPS_MAXIMIZE2"] = "Всегда развернут"
...
L["STRING_OPTIONS_WALLPAPER_LOAD_EXCLAMATION"] = [=[Для изображения нужно:
...
L["STRING_OPTIONS_WALLPAPER_LOAD_TROUBLESHOOT_TEXT"] = [=[Если обои отображаются полностью в зеленым цвете:
...
Когда окно закрыто, окно является неактивным и может быть возобновлено в любое время с помощью меню управления.
...
|cFFFFFF00Совет|r: правый щелчок, ввести значение.
...
L["STRING_OPTIONS_WP_EDIT_DESC"] = "Откройте редактор изображений, чтобы изменить некоторые аспекты выбранного изображения."
...
L["STRING_RAID_WIDE"] = "[*] большие рейдовые восстановления"
...
L["STRING_REPORT_SINGLE_COOLDOWN"] = "использованы восстановление от"
...
L["STRING_RESIZE_HORIZONTAL"] = [=[Измените ширину всех
  окон в группе]=]
L["STRING_RESIZE_VERTICAL"] = [=[Изменение размера высоты всех 
 окон в группе]=]
...
L["STRING_SLASH_WIPECONFIG_CONFIRM"] = "Щелкните, чтобы продолжить переустановку"
...
L["STRING_WELCOME_11"] = [=[Если передумали, Вы всегда
...
L["STRING_WELCOME_15"] = [=[Интервал в секундах между каждым обновлением в окне.
...
L["STRING_WELCOME_2"] = [=[Если передумали, Вы всегда
сможете изменить снова, через панель параметров]=]
L["STRING_WELCOME_26"] = "Использование интерфейса: Растянуть"
L["STRING_WELCOME_27"] = [=[Выделенная кнопка растягивания. |cFFFFFF00Щелкните|r и |cFFFFFF00перетащите вверх!|r 
...
L["STRING_WELCOME_41"] = "Интерфейс зрелища хитрости:"
...
L["STRING_WELCOME_45"] = "Для получения дополнительных параметров настроек, проверьте панель параметров."
L["STRING_WELCOME_46"] = "Импорт настроек"
L["STRING_WELCOME_5"] = "Эффектив.режим:"
L["STRING_WELCOME_57"] = [=[Импорт основных параметров из уже установленных аддонов.

Каждый скин по-разному реагирует на импортированные параметры.]=]
...
L["STRING_WELCOME_6"] = "таймер каждого члена рейда ставится на удержание, если их активность прекращается и снова подсчитывается при возобновлении."
L["STRING_WELCOME_60"] = "Прозвище и аватар"
L["STRING_WELCOME_61"] = "Аватары отображаются на подсказках, а также в окне сведений об игроке."
L["STRING_WELCOME_62"] = "Отправляется другим членам вашей гильдии, которые тоже используют Details!. Изменяет ник вашего персонажа на прозвище."
...
L["STRING_WELCOME_67"] = [=[Нажмите Shift, чтобы развернуть подсказку игрока, чтобы показать все используемые заклинания.
...
L["STRING_WELCOME_7"] = "используется для рейтинга, этот метод использует прошедшее боевое время для измерения, УВС и ИВС на всех членов рейда."
