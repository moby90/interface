...
L["STRING_CUSTOM_DAMAGEONANYMARKEDTARGET"] = "Наносимый урон по других отмеченных целей"
...
L["STRING_OPTIONS_IGNORENICKNAME_DESC"] = "Когда включено, прозвища и аватары, установленные другими участниками гильдии, игнорируются."
...
Прозвища отправляются участникам гильдии с Details! используется вместо имени персонажа.]=]
...
L["STRING_OPTIONS_REALMNAME_DESC"] = [=[Когда включено, название мира персонажа не отображается.
...
L["STRING_OPTIONS_TIMEMEASURE_DESC"] = [=[|cFFFFFF00Активный|r: таймер каждого участника рейдовой группы, ставится на удержание, если их активность прекращается, и снова
подсчитывается при возобновлении, общий способ измерения УВС и ИВС.

|cFFFFFF00Эффективный|r: используется в рейтинге, этот метод использует прошедшее время боя для измерения УВС и ИВС - всех участников рейда.]=]
...
L["STRING_WELCOME_62"] = "Отправляется другим участникам вашей гильдии, которые тоже используют Details!. Изменяя, имя Вашего персонажа на прозвище."
